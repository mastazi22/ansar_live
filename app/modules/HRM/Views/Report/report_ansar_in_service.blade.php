            ...
            <div class="box box-solid">
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        <li class="active">
                            <a>Ansar Service Report</a>
                        </li>
                        <li class="pull-right">
                            <span class="control-label" style="padding: 5px 8px">
                                View report in&nbsp;&nbsp;&nbsp;<input type="radio" class="radio-inline" style="margin: 0 !important;" value="eng" ng-change="loadReportData('ansar_service_report',reportType)" ng-model="reportType">&nbsp;<b>English</b>
                                &nbsp;<input type="radio" ng-change="loadReportData('ansar_service_report',reportType)" class="radio-inline" style="margin: 0 !important;" value="bng" ng-model="reportType">&nbsp;<b>বাংলা</b>
                            </span>
                        </li>
                    </ul>
                    <div class="tab-content">
                        <div class="tab-pane active">
                            <div class="row">
                                <div class="col-sm-offset-4 col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <button class="btn btn-default" style="margin-top: 10px" ng-click="loadAnsarServiceRecord()">
                            ...
                            <div id="report-ansar-service">
                                <h3 style="text-align:center">[[report.header]]&nbsp;&nbsp; <a href="#" id="print-report"><span class="glyphicon glyphicon-print"></span></a></h3>
                                    ...
                                    <table class="table " style="width: auto" align="center">
                                        <tr>
                                            ...
                                            <td rowspan="4" align="center" valign="middle">
                                                <img ng-if="pi" src="{{asset('')}}[[ansar.profile_pic]]" class="img-thumbnail" style="width:120px;height: auto">
                                                <img ng-if="!pi" src="{{asset('')}}dist/img/nimage.png" class="img-thumbnail" style="width:120px;height: auto">
                                            </td>
                                        </tr>
                                        <tr>
