...
<div style="padding: 10px 0px 0;font-size: 14px">
    ...
    <table border="1" cellpadding="0" cellspacing="0" style="width: 100%">
        ...
        <tr>
            <td colspan="5"></td>
            <td>{{LanguageConverter::engToBng(collect($datas)->sum('total_daily_fee'))}}</td>
            <td>{{LanguageConverter::engToBng(collect($datas)->sum('total_ration_fee'))}}</td>
            <td>{{LanguageConverter::engToBng(collect($datas)->sum('total_barber_fee'))}}</td>
            <td>{{LanguageConverter::engToBng(collect($datas)->sum('total_transportation_fee'))}}</td>
            <td>{{LanguageConverter::engToBng(collect($datas)->sum('total_medical_fee'))}}</td>
            <td>০</td>
            <td>{{LanguageConverter::engToBng(collect($datas)->sum('extra'))}}</td>
            <td>{{LanguageConverter::engToBng(collect($datas)->sum('reg_fee'))}}</td>
            <td>{{LanguageConverter::engToBng(collect($datas)->sum('welfare_fee'))}}</td>
            <td>{{LanguageConverter::engToBng(collect($datas)->sum('share_amount'))}}</td>
            <td>{{LanguageConverter::engToBng(collect($datas)->sum('total_amount'))}}</td>
