...
@section('small_title','<a href="{{URL::route(\'recruitment.category.create\')}}" class="btn btn-primary btn-sm"><i class="fa fa-list"></i>&nbsp;Add New Category</a>')
@section('breadcrumb')
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered">
                            ...
                            <tr ng-repeat="jc in jobCategories">
                                ...
                                <td>[[jc.category_description|ucfirst]]</td>
                                <td>
