    ...
    @forelse($applicants as $a)
        <tr>
            ...
            @else
                ...
                <td>{{round($a->marks->convertedWrittenMark(),2)}}(out of {{$a->circular->markDistribution->convert_written_mark}}) and {{round($a->marks->written*35,2)}}(out of {{$a->circular->markDistribution->written}})
                </td>
                <td>{{$a->marks->viva}}</td>
