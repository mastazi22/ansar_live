            ...
            $data = '[
{
	"embodiment_id": 1664, 
	"ansar_id": 2377, 
	"transfered_kpi_join_date": "2018-04-02", 
	"kpi_id": 1070}, 
{
	"embodiment_id": 4162, 
	"ansar_id": 5892, 
	"transfered_kpi_join_date": "2017-02-07", 
	"kpi_id": 1070}, 
{
	"embodiment_id": 4308, 
	"ansar_id": 6100, 
	"transfered_kpi_join_date": "2018-05-17", 
	"kpi_id": 1070}, 
{
	"embodiment_id": 9469, 
	"ansar_id": 13868, 
	"transfered_kpi_join_date": "2018-07-22", 
	"kpi_id": 1070}, 
{
	"embodiment_id": 11834, 
	"ansar_id": 17345, 
	"transfered_kpi_join_date": "2018-04-17", 
	"kpi_id": 1070}, 
{
	"embodiment_id": 12165, 
	"ansar_id": 17874, 
	"transfered_kpi_join_date": "2018-02-27", 
	"kpi_id": 1070}, 
{
	"embodiment_id": 16878, 
	"ansar_id": 26017, 
	...
	"kpi_id": 1070}, 
{
	"embodiment_id": 22778, 
	"ansar_id": 37641, 
	"transfered_kpi_join_date": "2018-09-01", 
	"kpi_id": 1070}, 
{
	"embodiment_id": 30183, 
	"ansar_id": 49887, 
	"transfered_kpi_join_date": "2017-12-13", 
	"kpi_id": 1070}, 
{
	"embodiment_id": 30693, 
	"ansar_id": 50612, 
	"transfered_kpi_join_date": "2018-01-25", 
	"kpi_id": 1070}, 
{
	"embodiment_id": 36019, 
	"ansar_id": 57797, 
	...
	"kpi_id": 1070}, 
{
	"embodiment_id": 44321, 
	"ansar_id": 69307, 
	"transfered_kpi_join_date": "2018-03-22", 
	"kpi_id": 1070}, 
{
	"embodiment_id": 44328, 
	"ansar_id": 69314, 
	"transfered_kpi_join_date": "2018-03-18", 
	"kpi_id": 1070}, 
{
	"embodiment_id": 44373, 
	"ansar_id": 69367, 
	"transfered_kpi_join_date": "2017-12-04", 
	"kpi_id": 1070}, 
{
	"embodiment_id": 44375, 
	"ansar_id": 69370, 
	"transfered_kpi_join_date": "2018-03-14", 
	"kpi_id": 1070}, 
{
	"embodiment_id": 44582, 
	"ansar_id": 69596, 
	...
	"kpi_id": 1070}, 
{
	"embodiment_id": 48338, 
	"ansar_id": 4309, 
	"transfered_kpi_join_date": "2018-01-07", 
	"kpi_id": 1070}, 
{
	"embodiment_id": 55691, 
	"ansar_id": 16512, 
	"transfered_kpi_join_date": "2018-04-09", 
	"kpi_id": 1070}, 
{
	"embodiment_id": 56578, 
	"ansar_id": 38122, 
	"transfered_kpi_join_date": "2017-07-26", 
	"kpi_id": 1070}, 
{
	"embodiment_id": 56695, 
	"ansar_id": 23280, 
	"transfered_kpi_join_date": "2018-08-19", 
	"kpi_id": 1070}, 
{
	"embodiment_id": 56928, 
	"ansar_id": 37425, 
	"transfered_kpi_join_date": "2018-07-18", 
	"kpi_id": 1070}, 
{
	"embodiment_id": 62447, 
	"ansar_id": 35389, 
	...
	"kpi_id": 1070}, 
{
	"embodiment_id": 67054, 
	"ansar_id": 2162, 
	"transfered_kpi_join_date": "2018-01-21", 
	"kpi_id": 1070}, 
{
	"embodiment_id": 67693, 
	"ansar_id": 8105, 
	...
	"kpi_id": 1070}, 
{
	"embodiment_id": 70215, 
	"ansar_id": 78340, 
	"transfered_kpi_join_date": "2018-03-21", 
	"kpi_id": 1070}, 
{
	"embodiment_id": 70216, 
	"ansar_id": 78341, 
	...
	"kpi_id": 1070}, 
{
	...
	"kpi_id": 1070}
            ...
            foreach ($ansars as $ansar){
                $a = $data->whereLoose('ansar_id',$ansar)->first();
                if($a){
                    $e = \App\modules\HRM\Models\EmbodimentModel::find($a->embodiment_id);
                    if($e){
                        $e->update([
                            'kpi_id'=>$a->kpi_id,
                            'transfered_date'=>$a->transfered_kpi_join_date
                        ]);
                    }
                } else{
                    $e = \App\modules\HRM\Models\EmbodimentModel::where('ansar_id',$ansar)->first();
                    $e->update([
                        'kpi_id'=>'1070',
                        'transfered_date'=>$e->joining_date
                    ]);
                }
            }
        });
