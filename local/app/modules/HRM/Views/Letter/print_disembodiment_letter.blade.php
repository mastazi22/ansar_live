@if($i==0)<h3 style="text-align: center" class="print-hide">Disembodiment Letter&nbsp;&nbsp;<a href="#"
                                                                                               id="print-report"><i
                class="fa fa-print"></i></a></h3>@endif
<div class="letter">
    ...
    <div class="letter-body">
        ...
        <p class="letter-content-top">
            আনসার বাহিনী আইন ১৯৯৫ খ্রিঃ এর ধারা ৬ (৪), আনসার ও গ্রাম প্রতিরক্ষা বাহিনী সদর দপ্তরের স্মারক নং-আইন-৫১/আনস,
                ...
                @for($j=0;$j<count($result);$j++)
                    @if(isset($result[$j]))
                        <tr>
                            ...
                            <td>{{$result[$j]->rank}}</td>
                            <td style="width: 150px !important;">{{$result[$j]->name}}<br>{{$result[$j]->father_name}}
                            </td>
