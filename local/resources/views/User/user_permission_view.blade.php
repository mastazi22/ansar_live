    ...
    <script type="text/ng-template" id="field_renderer.html">
        <label class="control-label" ng-if="p.name!=undefined">
            <div class="styled-checkbox">
                <input permission-check type="checkbox" id="p_[[$parent.$index]]_[[$index]]"
                       ng-model="permissionList[$parent.$index][$index]" ng-change="" name="permission[]"
                       value="[[p.value]]">
        ...
        <ul ng-if="p.text!=undefined" class="sub-permission">
            <li>
                ...
                <ul>
                    <li ng-repeat="p in p.actions" ng-include="'field_renderer.html'">
                    </li>
                </ul>
            </li>
        </ul>
                ...
                <div class="box box-solid">
                    <div class="box-header">
                        ...
                        <label class="control-label">
                            ...
                            <div class="styled-checkbox">
                                <input type="checkbox" id="all" ng-change="permitAll()" ng-model="grantAll"
                                       name="permit_all" value="permit_all">
                                <label for="all"></label>
                            </div>
