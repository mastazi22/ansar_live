        ...
        $(document).ready(function () {
            ...
            $("#save_image").on('click', function (e) {
                ...
                $("#profile_pic").ajaxSubmit({
                    ...
                    success: function (r) {
                        if(r.status) $('body').notifyDialog({type:'success',message:'Profile Image Upadet Complete'}).showDialog()
                        else $('body').notifyDialog({type:'error',message:'Can not update profile image.Try again later'}).showDialog()
                        ...
                        <div id="personal-info" class="tab-pane active">
                            <div class="row">
                                <div class="col-sm-6 col-sm-offset-1">
                                    <form id="user_profile_form" action="{{action('UserController@updateProfile')}}" method="post" class="form-horizontal">
                                        {{csrf_field()}}
                                        ...
                                        <div class="form-group has-feedback">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" name="office_phone_no" value="{{$user->userProfile->office_phone_no}}"
                                        ...
                                        <div class="form-group has-feedback">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" name="mobile_no" value="{{$user->userProfile->mobile_no}}"
                                        ...
                                        <div class="form-group has-feedback">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" name="contact_address" value="{{$user->userProfile->contact_address}}"
                                            ...
                                            <div class="col-sm-4 col-sm-offset-8">
                                                <button type="submit" class="btn btn-primary btn-block btn-flat">
                                                    ...
                                                    <div class="submitting">
                                                        <i class="fa fa-spinner fa-spin"></i><span class="blink-animation">Updating...</span>
                                                    </div>
                                                </button>
                                            </div>
                                            <!-- /.col -->
                                ...
                                <div class="col-sm-4">
                                    <div style="position: relative">
                                        <div class="progress" >
                                            <div id="pppppp" style="display: none;" class="progress-bar progress-bar-success progress-bar-striped active" role="progressbar" aria-valuemin="0" aria-valuemax="100" aria-valuenow="10" style="width: 100%">
                                                40%
                                            </div>
                                        </div>
                                        <img id="p_image" style="display: block;width: 200px;height: 200px;margin: 0 auto" class="img-responsive img-circle img-thumbnail" src="{{action('UserController@getImage',['file'=>auth()->user()->userProfile->profile_image])}}">
                                    </div>
                                    <div style="position: relative;padding: 10px">
                                        <form id="profile_pic" enctype="multipart/form-data" action="{{action('UserController@changeUserImage')}}" method="post">
                                            <div style="position: relative;border: 1px solid #0000C2;overflow: hidden">
                                                <button id="change_picture" class="btn btn-primary" style="float: left;border-radius:0"> Change Picture</button>
                                                <p id="img_src" style="float: left;padding: 5px 10px;display: block;margin: 0;box-sizing: border-box;width: 59%;overflow:hidden;text-overflow: ellipsis;white-space: nowrap"></p>
                                                <div class="clearfix"></div>
                                            </div>
                                            <button style="display: block;margin: 10px 0;width:100%;" type="submit" class="btn btn-primary" id="save_image" class="btn btn-success">Save</button>
                                            <input type="file" name="image_file" style="visibility: hidden;z-index: -1;position: absolute"; id="profile_pic_chose">
                                        </form>
                            ...
                            <div class="row" >
                                <div class="col-sm-4 col-sm-offset-4" style="margin-bottom: 20px">
                                    ...
                                    <form id="user-password-form" action="{{action('UserController@changeUserPassword')}}" method="post">
                                        ...
                                        <div class="form-group has-feedback">
                                            <input type="password" name="c_password" value="" class="form-control" placeholder="Confirm new password"/>
                                            <span class="glyphicon glyphicon-lock form-control-feedback"></span>
                                            <p style="display: none" class="alert-danger-custom"><i class="fa fa-warning"></i><span>Password mis-match</span></p>
                                        </div>
                                        <div>
